...
Place the following lines **before** the `colorscheme twodark` line in your `~/.vimrc`, then change the example overrides to suit your needs:
...
This also needs to be done **before** `colorscheme twodark`.
